...
class CompanyDataProcessor:
    ...
    def __init__(self, file1_path, file2_path, common_column):
        """
...
# Usage example:
processor = CompanyDataProcessor("C:\\Users\\bunas\\Downloads\\cm26APR2024bhav.csv", "C:\\Users\\bunas\\OneDrive\\Desktop\\CODE\\SST_PROJECT\\tables\\table.csv", "Name")
processor.merge_and_save()
